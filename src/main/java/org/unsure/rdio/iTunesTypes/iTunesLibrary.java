package org.unsure.rdio.iTunesTypes;
...
public class iTunesLibrary {
    ...
    private final Map<String, Map<String, Map<String, NSDictionary>>> artistsAlbums = new HashMap<String, Map<String, Map<String, NSDictionary>>>();
